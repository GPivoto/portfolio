...
export function Projects() {
  return (
    <section id="projects" className="px-8 sm:px-14 md:px-20 mt-20 md:mt-25">
      <div className="max-w-400 mx-auto w-full">
        <div className="flex flex-col items-center space-y-5 md:space-y-7">
          ...
          <h3 className="text-3xl md:text-5xl lg:text-6xl">Alguns <span className="text-purple-100">projetos</span></h3>
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-8 my-16">
          {projetos.map((item, index) => (
            <li
              key={index}
              className="flex flex-col lg:flex-row items-center justify-center border border-gray-400 rounded-xl py-5 px-5 md:gap-2 lg:gap-0 hover:-translate-y-1 duration-500 hover:shadow-black"
            >
              <a
                href={item.href}
                target="_blank"
