...
export function Navbar() {
  ...
  return (
    <>
      <header
        id="home"
        className="border-b border-gray-50 max-w-400 mx-auto w-full py-3 flex justify-between items-center px-8 sm:px-14 md:px-20 sticky top-0 bg-white z-50 backdrop-blur-3xl"
      >
