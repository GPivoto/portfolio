...
export function Navbar() {
  ...
  return (
    <>
      ...
      <div
        className={`md:hidden z-99 absolute top-0 right-0 bottom-0 overflow-hidden bg-[#9c82cb] border-l transition-all duration-500 ${
          visible ? "w-1/2" : "w-0"
        }`}
      >
        <div
        ...
        <ul className="mt-20 px-10 space-y-4">
          <li className="hover:-translate-y-1 transition-transform duration-300 ease-in-out">
            <a
              href="#home"
              className="relative font-semibold text-white transition-all duration-300 ease-in-out hover:text-white group"
            >
              Home
